...
const backupPath = path.join(
  process.cwd(),
  "src",
  `App-before-force-visible-portal-controls-${new Date()
    .toISOString()
    .replace(/[:.]/g, "-")}.jsx`
);
...
const marker = "FORCED_PORTAL_CONTROLS_FOR_PLAYWRIGHT";
...
console.log("Forced visible portal controls patch applied.");
