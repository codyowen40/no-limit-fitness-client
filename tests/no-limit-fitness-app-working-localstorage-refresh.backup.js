...
test.describe("No Limit Fitness full app test", () => {
  test("checks full frontend flow including Messages and localStorage refresh", async ({
    page,
  }) => {
    ...
    await test.step("localStorage keeps clients, plans, logs, and messages after refresh", async () => {
      await page.reload();
