...
export default function App() {
  ...
  const [localSaveNotice, setLocalSaveNotice] = useState(
    "Local saving is active. Clients, plans, logs, messages, unread indicators, and activity read status will stay after refresh."
  );
...
function HomeScreen({
  ...
  const homeCards = [
    ...
    },
    {
      ...
      text: "Review completed workouts, substitutions, notes, plans, and messages.",
      icon: Bell,
      target: "Coach",
    },
  ];
        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-3xl text-base leading-7 text-white/70">
              ...
              messages, and review coach activity from one structured frontend.
            </p>
  ...
  return (
    <div>
      <SectionHeader
        ...
        description="A structured coach activity center for workout completions, skipped workouts, changed values, substitutions, client notes, assigned plans, and messages."
      />
