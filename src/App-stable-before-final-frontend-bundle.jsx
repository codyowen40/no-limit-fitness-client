...
export default function App() {
  ...
  const [localSaveNotice, setLocalSaveNotice] = useState(
    "Local saving is active. Clients, plans, logs, messages, unread indicators, activity read status, and workout log details will stay after refresh."
  );
  ...
  const unreadActivityCount = coachNotifications.filter(
    (item) => !item.isRead
  ).length;
...
function HomeScreen({
  ...
  const homeCards = [
    ...
    },
    {
      ...
      text: "Review completed workouts, substitutions, notes, plans, messages, and log details.",
      icon: Bell,
      target: "Coach",
    },
  ];
        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-3xl text-base leading-7 text-white/70">
              ...
              messages, review coach activity, and inspect detailed workout logs from
              one structured frontend.
            </p>
  ...
  return (
    <div>
      <SectionHeader
        ...
        description="Create sample clients locally for now. New clients also get a local message thread."
      />
