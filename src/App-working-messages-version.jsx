...
export default function App() {
  ...
  const [selectedConversationId, setSelectedConversationId] = useState("client-1");
        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-3xl text-base leading-7 text-white/70">
              Build plans, assign them to clients, track completed workouts, and
              now manage local coach/client messages with unread indicators.
            </p>
  ...
  return (
    <div>
      <SectionHeader
        ...
        description="Send local in-app messages between coach and clients. This is frontend-only for now, with unread indicators saved in React state."
      />
